...
## Export master table in xlsx file

```{r export data, message=FALSE, warning=FALSE}

library(xlsx)

write.xlsx(df_master ,paste0( "Cleaned data/RTM_master_tbl " , Sys.Date() ,  ".xlsx"  ))
...
df_master = df_master %>% select (- c(EnuName ,HHH_YN,HHHAge, IDPDuration,HWaterSRC, MktAccess_1M, HHIncChg_1M, RespNationality, HHSizebelow2, HToiletType, HElectricitySRC_1,HElectricitySRC_2, HElectricitySRC_3, base_weights , ADMIN2Name ) )
